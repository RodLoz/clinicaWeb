...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2022 at 04:42 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPdet_disp` (`cod_doctor` CHAR(5), `Cod_Disponibilidad` CHAR(5))  BEGIN
DECLARE CUENTA INT;
DECLARE CODE CHAR(5);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CAMBIA_DISPANULAR` (IN `codD` CHAR(5), IN `Fi` DATETIME, IN `Ff` DATETIME, IN `Tur` VARCHAR(6))  UPDATE clinicaprueba.disponibilidad SET Cod_Disponibilidad=codD,Estado="0", Fecha_Inicio=Fi, Fecha_Fin=Ff,Turno=Tur WHERE Cod_Disponibilidad=codD$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_CAMBIA_DISPONIBILIDAD` (IN `codD` CHAR(5), IN `Fi` DATETIME, IN `Ff` DATETIME, IN `Tur` VARCHAR(6))  UPDATE clinicaprueba.disponibilidad SET Cod_Disponibilidad=codD,Estado="1", Fecha_Inicio=Fi, Fecha_Fin=Ff,Turno=Tur WHERE Cod_Disponibilidad=codD$$
...
('C0002', 'P0001', '2022-04-02 13:00:00', '2022-04-02 14:00:00', 'D0002', 'Factura', 80, 'DT003');
...
--
-- Table structure for table `detalle_disponibilidad`
--
...
--
-- Dumping data for table `detalle_disponibilidad`
--
...
('DP003', '1', '2022-04-02 13:00:00', '2022-04-02 14:00:00', 'tarde'),
...
('DP017', '0', '2022-04-12 15:00:00', '2022-04-12 16:00:00', 'tarde'),
('DP018', '0', '2022-04-20 15:00:00', '2022-04-20 16:00:00', 'tarde'),
('DP019', '0', '2022-04-12 19:00:00', '2022-04-12 20:00:00', 'noche'),
('DP020', '0', '2022-04-23 20:00:00', '2022-04-23 21:00:00', 'noche');
...
('D0004', 'Roberto', '2018-10-17', 'Cordova', 'F', 'E0002', 'CS004'),
('D0005', 'Rosa Irma', '2019-05-05', 'Villalobos', 'F', 'E0006', 'CS005'),
...
('D0012', 'Jose Junior', '2019-01-28', 'Silva', 'M', 'E0001', 'CS012'),
('D0013', 'Esteban', '2022-03-20', 'Diaz', 'M', 'E0002', 'CS013');
...
('H0001', 'P0001', 'D0007', '2022-03-06 15:00:00', 'C0001', 'Primer chequeo medico', 'Culminado', '', '', ''),
('H0002', 'P0001', 'D0002', '2022-04-02 13:00:00', 'C0002', 'Chequeo semanal', 'Culminado', 'Cuenta con dolor de pecho al momento de respirar', '1 pastilla de  ibuprofeno por 15 dias\r\n', 'Tomar medicamentos antiflamatorios');
...
('P0001', 'Pedro', 'Sandoval', '966654321', '70612215', 'pedro@gmail.com', '12345'),
('P0002', 'Angel', 'Cordova', '944741067', '70616655', 'angel@gmail.com', '70616655'),
...
('12312', 'U0008', 'qweqwe', 'qwe', '213123', 'qweqwe@wqeqw', 'Paciente', '12312'),
('13342343', 'U0006', 'Mikas', 'Mallqui', '988765432', 'mikas@gmail.com', 'Paciente', '13342343'),
('23123', 'U0009', 'qewqweqwe', 'qwe', '213123', 'wqe@eqweqwe', 'Paciente', '23123'),
...
--
-- Indexes for table `detalle_disponibilidad`
--
